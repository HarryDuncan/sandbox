...
export const ATUtil = {
	...
	randomVector3: function(range){
		return new Vector3(ATUtil.randomRange(-range,range),ATUtil.randomRange(-range,range),ATUtil.randomRange(-range,range));
	},
	randomVector2: function(range){
		return new Vector2(ATUtil.randomRange(-range,range),ATUtil.randomRange(-range,range));
	},
