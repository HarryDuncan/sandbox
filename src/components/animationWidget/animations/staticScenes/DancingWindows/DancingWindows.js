...
export const DancingWindows = (framework) => {
  ...
  let groundPlane, wallMat;
    ...
    const rMap = loader.load( '../images/art/OhHoney.jpg' );
    ...
    redRectLight.add( redRectLightHelper );
		...
		function updateCubeMap() {
			...
			cubeCamera.update( framework.renderer, scene );
