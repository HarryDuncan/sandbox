...
export function TransLights(framework) {
		...
		const geoKnot = new THREE.TorusKnotGeometry( 20, 5, 100, 16 );
		const matKnot = new THREE.MeshStandardMaterial( { color: 0xffffff, roughness: 0, metalness: 0 } );
		const meshKnot = new THREE.Mesh( geoKnot, matKnot );
		meshKnot.name = 'meshKnot';
		meshKnot.position.set( 0, 35, -60 );
		
		scene.add( meshKnot );


		const rectLight1 = new THREE.RectAreaLight( 0x55cdfc, 25, 20, 400);
		...
		const rectLight2 = new THREE.RectAreaLight( 0xf7a8b8, 25, 20, 400 );
		...
		const rectLight4 = new THREE.RectAreaLight(  0xf7a8b8, 25, 20, 400);
		...
		const rectLight5 = new THREE.RectAreaLight(0x55cdfc, 25, 20, 400);
